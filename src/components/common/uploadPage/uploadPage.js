  ...
  return (
    <div className="App center">
      <header>
        ...
        <p className="tagline">
          Find out what caught your attention you the most
        </p>
        <p className="intro">
          To show you your most watched videos, you need to upload your{" "}
          <code>watch-history.json</code>-file to this site.
        </p>
      </header>
      <Overlay>
        <button
